...
import Section from '../components/Section'; // Assuming Section component allows for content alignment
    ...
    <div className="bg-cover bg-no-repeat bg-center" style={{ backgroundImage: "url('/Untitled design_20250429_204502_0000.png')" }}>
      ...
      <div className="min-h-screen pt-20 px-4">
        <section className="text-center mb-16">
            ...
            {[
              ...
              <span
                ...
                className="text-gray-100 cursor-pointer border px-6 py-2 rounded-md transition-all duration-300
                          hover:shadow-[0_0_15px_4px_rgba(168,85,247,0.7)] hover:bg-purple-300 hover:text-white"
              >
                {label}
              </span>
            ))}
          ...
          {/* Section titles modified to align left */}
          <Section title={
            <div className="text-white text-left"> {/* Changed text-center to text-left */}
